...
function build_emps_table(result){
    ...
    $.each(emps,function (index){
        ...
        const hireDateTd = $("<td></td>").append(this.hireDate);
        const salaryTd = $("<td></td>").append(this.salary);
...
$(function (){
    ...
    function getEmp(empId){
        $.ajax({
            ...
            success:function (result){
                ...
                $("#photo_update_input").val(empData.photo);
                $("#empName_update_input").val(empData.empName);
                $("#hire_date_update_input").val(empData.hireDate);
                $("#salary_update_input").val(empData.salary);
                $("#empUpdateModal input[name=gender]").val([empData.gender]);
                $("#depts_update_select option[value='"+empData.deptId+"']").prop("selected",true);
                //console.log(empData.deptId);
            }
        });
    }
    ...
    $("#avatar_file").change(function () {
        ...
        reader.onload = function () {
            ...
            $("#photo_update_input").attr("src", this.result);
    ...
    $("#emp_update_btn").click(function (){
        ...
        formFile.append("employee", $("#empUpdateModal form").serialize() + "&_method=PUT");
        formFile.append("headerImg", $("#avatar_file")[0].files[0]);
        console.log("formFile:",$("#avatar_file")[0].files[0]);
        $.ajax({
            url:APP_PATH+"/emp/"+empId,
            dataType : 'json',
